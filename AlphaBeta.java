...
{
	public String maxPlayer,minPlayer,boardCurrState[][],node,depth,value,logValue,alpha,beta;
	...
	public AlphaBeta(String maxPlayer,String minPlayer,String[][] boardCurrState,int maxDepth)
	{
	...
	public void AlphaBetaImplementation() throws IOException
	{
		...
		int Fvalue = Max_Value_Fn(rootState,currDepth,-1,-1,-999999,999999,0);
	...
	*/	
	...
	public int Max_Value_Fn(String[][] tempArray_1,int currDepth,int moveX1,int moveY1,int alpha1,int beta1,int pass1)
	{
		...
		if(currDepth == maxDepth)
		{
			...
			if(alpha1 == -999999)
				...
				alpha = Integer.toString(alpha1);
			if(beta1 == 999999)
				beta = "Infinity";
			else
				beta = Integer.toString(beta1);
			logValue = node + "," +depth +"," +value +"," +alpha +","+beta;
			log.add(logValue);
			return evalval1;
		}
		...
		if(noOfMoves == 0)
		{
			...
			else
			{
				...
				for(int j=0;j<8;j++)
					for(int k=0;k<8;k++)
						boardState_1[j][k]=tempArray_1[j][k];
				v = MAX(v,Min_Value_Fn(boardState_1,currDepth,-10,-10,alpha1,beta1,maxPass));
		...
		{	
			...
			int vBefore = v;
			v = MAX(v,Min_Value_Fn(boardState_1,currDepth,legalMoves_1[r][0],legalMoves_1[r][1],alpha1,beta1,maxPass));
	...
	public int Min_Value_Fn(String[][] tempArray_2,int currDepth,int moveX2,int moveY2,int alpha2,int beta2,int pass2)
	{
		...
		if(currDepth == maxDepth)
		{
			...
			if(alpha2 == -999999)
				...
				alpha = Integer.toString(alpha2);
			if(beta2 == 999999)
				beta = "Infinity";
			else
				beta = Integer.toString(beta2);
			logValue = node + "," +depth +"," +value +"," +alpha +","+beta;
			log.add(logValue);
	...
	*/	
		...
		if(noOfMoves == 0)
		{
			...
			else
			{
				...
				for(int j=0;j<8;j++)
					for(int k=0;k<8;k++)
						boardState_2[j][k]=tempArray_2[j][k];
				v = MIN(v,Max_Value_Fn(boardState_2,currDepth,-10,-10,alpha2,beta2,minPass));
		...
		{	
			...
			v = MIN(v,Max_Value_Fn(boardState_2,currDepth,legalMoves_2[r][0],legalMoves_2[r][1],alpha2,beta2,minPass));
